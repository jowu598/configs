...
"let g:instant_markdown_open_to_the_world = 1 let g:instant_markdown_allow_unsafe_content = 1
...
nmap <leader>v :vsp ~/.config/nvim/init.vim<CR>
nmap <leader>t :call TrimWhitespace()<CR>
nmap <leader>k <Plug>(pydocstring)
nmap <leader>a gaip*
nmap <leader>s :Rg<CR>
nmap <leader>d :Files<CR>
nmap <leader><leader>f :BLines<CR>
...
function! NERDTreeFindAndBack()
    NERDTreeFind | wincmd p
endfunction
nmap <leader>t :NERDTreeToggle<CR>
nmap <leader>w :call NERDTreeFindAndBack()<CR>
nnoremap <F1> <C-O>
nnoremap <F3> <C-I>
...
" default updatetime vim-signify 4000ms is not good for async update
set updatetime=500
